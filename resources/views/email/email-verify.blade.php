				...
				<td>
					<table class="row row-1" align="center" width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt;">
						<tbody>
							<tr>
								<td>
									<table class="row-content stack" align="center" border="0" cellpadding="0" cellspacing="0" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; color: #000000;" width="800">
										<tbody>
											<tr>
														...
														<tr>
															<td style="padding-left:60px;padding-top:20px;width:100%;padding-right:0px;">
																<div style="line-height:10px">
                                                                    ...
                                                                    <img src="{{ asset('assets/img/logo/logo.png') }}" style="display: block; height: auto; border: 0; width: 80px; max-width: 100%;" width="171">
                                                                </div>
															</td>
														</tr>
													</table>
															...
															<td style="padding-bottom:10px;padding-left:60px;padding-right:10px;padding-top:40px;">
																<div style="font-family: sans-serif">
																	<div style="font-size: 14px; mso-line-height-alt: 16.8px; color: #393d47; line-height: 1.2; font-family: Arial, Helvetica Neue, Helvetica, sans-serif;">
																		<p style="margin: 0; font-size: 14px;"><strong><span style="font-size:18px;">Verifikasi Registrasi Autismart</span></strong></p>
																	</div>
																</div>
															</td>
														</tr>
													...
													<table class="text_block" width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; word-break: break-word;">
														<tr>
															<td style="padding-bottom:10px;padding-left:60px;padding-right:10px;padding-top:10px;">
																<div style="font-family: sans-serif">
																	<div style="font-size: 14px; mso-line-height-alt: 16.8px; color: #393d47; line-height: 1.2; font-family: Arial, Helvetica Neue, Helvetica, sans-serif;">
																		<p style="margin: 0; font-size: 14px;">Hi {{$name}},<br>Untuk verifikasi akun baru, silahkan tekan tombol di bawah ini</p>
																	</div>
																</div>
															</td>
														</tr>
														...
														<tr>
															<td style="padding-left:40px;padding-top:5px;width:100%;padding-right:0px;">
																<div style="line-height:10px">
                                                                    ...
                                                                    <img src="https://d15k2d11r6t6rl.cloudfront.net/public/users/Integrators/BeeProAgency/728025_711064/pidi-verified-email-button.png" style="display: block; height: auto; border: 0; width: 290px; max-width: 100%;" width="290">
                                                                    </a> --}}
                                                                    <a href="{{$url}}" class="button button-primary" target="_blank" rel="noopener" style="margin:0 0 20px 20px;padding:5px 0;box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; -webkit-text-size-adjust: none; border-radius: 4px; color: #fff; display: inline-block; text-decoration: none; background-color: #2d3748; border-bottom: 8px solid #2d3748; border-left: 18px solid #2d3748; border-right: 18px solid #2d3748; border-top: 8px solid #2d3748;">
