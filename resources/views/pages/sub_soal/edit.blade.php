                ...
                <form method="POST" action="{{route('sub-soal.update', $data->id)}}">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control @error('correct_answer') is-invalid @enderror" value="{{$data->correct_answer}}" name="correct_answer" id="correct_answer" type="text" placeholder="Input correct_answer">
