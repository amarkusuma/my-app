                ...
                <form method="POST" action="{{route('news-category.store')}}">
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <input class="form-control @error('category') is-invalid @enderror" name="category" id="category" type="text" placeholder="Input category">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control @error('description') is-invalid @enderror" name="description" id="textarea-input" rows="4" placeholder="Description.."></textarea>
