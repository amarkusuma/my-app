                ...
                <form method="POST" action="{{route('sub-learn.update', $data->id)}}" enctype="multipart/form-data">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="custom-file">
                                <input class="form-control custom-file-input @error('video') is-invalid @enderror" name="video" id="video" type="file" onchange="getVideoChange()" accept=".mp4,.MP4,.webm,.WEBM,.avi,.AVI" placeholder="Input video">
                                ...
                                <div data-repeater-list="soal_images">
                                            ...
                                            <div class="d-flex">
                                                <div class="input-group">
                                                    <div class="custom-file file-images">
                                                        ...
                                                        <input type="file" name="{{"soal_images[$index][image]"}}" class="custom-file-input" accept=".png,.PNG,.jpg,.jpg,.jpeg,.JPEG" id="inputGroupFile01"  onchange="getImagesChange(this)">
                                    ...
                                    <div data-repeater-item class="form-group">
                                        <div class="d-flex">
                                            <div class="input-group">
                                                <div class="custom-file">
                                                    <input type="file" name="image" class="custom-file-input" accept=".png,.PNG,.jpg,.jpg,.jpeg,.JPEG" id="inputGroupFile01" onchange="getImagesChange(this)">
                                                    <label class="custom-file-label" id="inputLabelImages" for="inputGroupFile">Choose image</label>
                                                </div>
                                            </div>
                                            <input data-repeater-delete class="btn btn-outline-danger btn-sm ml-lg-2 ml-1" type="button" value="Delete" />
