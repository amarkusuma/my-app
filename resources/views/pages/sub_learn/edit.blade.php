                ...
                <form method="POST" action="{{route('sub-learn.update', $data->id)}}" enctype="multipart/form-data">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control @error('sub_name') is-invalid @enderror" value="{{$data->sub_name}}" name="sub_name" id="sub_name" type="text" placeholder="Input sub_name">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control @error('min_correct') is-invalid @enderror" value="{{$data->min_correct}}" name="min_correct" id="min_correct" type="text" placeholder="Input min_correct">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control @error('link_youtube') is-invalid @enderror" value="{{$data->link_youtube}}" name="link_youtube" id="link_youtube" type="text" placeholder="Input link_youtube">
