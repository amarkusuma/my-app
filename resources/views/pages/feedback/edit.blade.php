    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <form method="POST" action="{{route('feedback.update', $data->id)}}">
                    @method('PUT')
                    @csrf
                    <div class="card-body">
                        <div class="form-group">
                            <label for="textarea-input">Feedback</label>
                            <textarea class="form-control @error('comment') is-invalid @enderror" name="comment" id="textarea-input" rows="4" placeholder="comment..">{{$data->comment}}</textarea>
