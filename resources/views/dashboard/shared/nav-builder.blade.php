...
?>
        ...
        <div class="c-sidebar-brand">
            <img class="c-sidebar-brand-full rounded-lg" style="height: 50px;width: 50px !important" src="{{ url("/assets/img/logo/logo2.jpeg") }}" width="118" height="46" alt="CoreUI Logo">
